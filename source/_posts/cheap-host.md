---
title: 便宜主机测评：年费20多元的香港VPS值得买吗？
date: 2025-11-30 15:51:12
updated: 2026-04-18 22:05:12
categories:
  - 云服务器测评
tags:
  - 主机
  ...
  - 便宜主机
  - 服务器测评
keywords: '便宜VPS, 香港主机, 云服务器测评, 低价VPS, 便宜主机推荐, VPS评测'
description: 真实测评年费仅20多元的香港VPS主机：1核0.5G10GB配置，详细测试硬件性能、IP质量、三网延迟、网络测速、回程路由和流媒体解锁情况。结论是勉强能用，适合玩玩不适合生产环境。
author: 裕裕裕
reading_time: 5分钟
comments: true
copyright: true
...
今天逛知乎时，发现了这么一篇文章[知乎文章：便宜主机推荐](https://zhuanlan.zhihu.com/p/1978054135757681899?share_code=FwqLQYbSr6rY&utm_psn=1978487368194494544)

这篇文章介绍了一个贼便宜的主机，于是乎，我也买了。

## 购买的主机配置

我买的是香港的主机

![便宜主机购买页面](https://photo.yu-blog.top/20251130153513979.webp)
...
![主机硬件测试](https://photo.yu-blog.top/20260412140515081.webp)

### IP质量

![ipv4测试](https://photo.yu-blog.top/20260412140902121.webp)
![ipv6测试](https://photo.yu-blog.top/20260412140932248.webp)

### 然后这是这台主机的网络测速

![主机网络测速结果](https://photo.yu-blog.top/20251130153358928.webp)

### 三网回程

![1](https://photo.yu-blog.top/20260412150903406.webp)
![2](https://photo.yu-blog.top/20260412150945312.webp)

### 网络延迟

![ipv4](https://photo.yu-blog.top/20260412154448547.webp)
![ipv6](https://photo.yu-blog.top/20260412164452126.webp)

### 流媒体解锁情况（有点长，就懒得截图了，全部复制下来了）

 ** 测试时间: Sat Apr 18 14:11:44 UTC 2026

** 正在测试IPv4解锁情况
--------------------------------

 ** 您的网络为: Prime Security (198.176.*.*) 

============[ Multination ]============
 Dazn:                  原生解锁        Yes (Region: SG)
 TikTok:                原生解锁        Yes (Region: SG)
 Disney+:               原生解锁        Yes (Region: HK)
 Netflix:               原生解锁        Yes (Region: HK)
 YouTube Premium:       原生解锁        Yes (Region: SG)
 Amazon Prime Video:    原生解锁        Yes (Region: SG)
 ...
 Google Gemini:         原生解锁        Yes (Region: SGP)
 Bing Region:                           SG
 Wikipedia Editability:                 Yes
 Instagram Licensed Audio:              Failed
 ---Forum---
 Reddit:                原生解锁        Yes (Region: Unknown)
=======================================
==============[ Taiwan ]===============
 KKTV:                                  No
 LiTV:                                  Failed
...
===========[ North America ]===========
 ...
 Tubi TV:                               Yes
/dev/fd/62: line 4083: MediaUnlockTest_MathsSpot: command not found
 Sling TV:                              Failed (Network Connection)
 Pluto TV:                              Yes
...
可以看到啊，只能说勉强能用，但是想要当主力是肯定不可能的，况且才1h0.5g，性能也不够用啊。。。

然后这台机子预装Debian，没有公网ipv4，但是有一个公网ipv6。

## 总结

所以各位玩玩就好，才20多一年要啥自行车呢（保不准啥时候跑路呢？）。。

[便宜主机注册链接](https://my.flapjacks.it/aff.php?aff=152)

还有最近可能没啥空，学业繁重，更新不定期，望谅解
